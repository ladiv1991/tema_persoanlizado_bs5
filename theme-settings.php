 ...
 * theme-settings.php
 *
 * Provides theme settings for Tema personalizado BS5
 */
 ...
 */
function tema_personalizado_bs5_form_system_theme_settings_alter(&$form, FormStateInterface $form_state, $form_id = NULL) {
  ...
  foreach ($tema_personalizado_bs5_contained_regions as $contained_region_name => $contained_region_title) {
